            ...
            <section className="text-gray-600 body-font">
                <div className="container mx-auto flex px-5 py-12 mt-12 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <h1 className="text-4xl font-bold uppercase">Inception</h1>
                        ...
                        <div className='my-5'>
                            <p className='flex'><h4>Directors :</h4> <span className='ml-6'><a href=''>Christopher Nolan</a></span></p>
                            <p className='flex'><h4>Starring :</h4> <span className='ml-6'><a href=''>Leonardo DiCaprio, Ken Watanabe, Joseph Gordon-Levitt</a></span></p>
                            <p className='flex'><h4>Genres :</h4> <span className='ml-6'><a href=''>Science Fiction, Fantasy, Adventure, Action</a></span></p>
                            <p className='flex'><h4>Subtitles :</h4> <span className='ml-6'><a href=''>English [CC]</a></span></p>
                            <p className='flex'><h4>Audio languages :</h4> <span className='ml-6'><a href=''>English, English [Audio Description]</a></span></p>
                        </div>
                    ...
                    <div className="lg:max-w-lg lg:w-full md:w-2/2 w-6/6">
                        ...
                        <img src={movie} className="max-w-sm  shadow-2xl" />
                        <div className='mt-5'>
