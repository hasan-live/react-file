...
const MovieTamilSection = () => {
    ...
    const getMyPostData = async () => {
        ...
        try {
            ...
            setMovTvShows(res.data.data[3].frontend_custom_content_limited_data);
        } catch (error) {
            ...
            <section className="text-gray-600 py-6 mt-5 ">
                <div className="container max-width px-5 mx-auto">
                    <div className=" flex flex-col divide-y divide-dashed text-center w-full  items-start mb-3">
                        <h1 className="text-3xl font-bold  title-font mb-4  text-gray-900 uppercase">Tamil</h1>
                    </div>
                </div>
...
export default MovieTamilSection;